...
GRANT CREATE NOTEBOOK PROJECT ON SCHEMA MLOPS_SCHEMA TO ROLE E2E_SNOW_MLOPS_ROLE;
GRANT CREATE TASK ON SCHEMA MLOPS_SCHEMA TO ROLE E2E_SNOW_MLOPS_ROLE;
GRANT EXECUTE TASK ON ACCOUNT TO ROLE E2E_SNOW_MLOPS_ROLE;
USE ROLE E2E_SNOW_MLOPS_ROLE;
...
CREATE COMPUTE POOL IF NOT EXISTS MLOPS_COMPUTE_POOL2 
 MIN_NODES = 1
 MAX_NODES = 3
